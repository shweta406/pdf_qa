...
os.environ['HF_TOKEN']=os.getenv("HF_TOKEN") #we are using hugging face embedding
...
api_key=st.text_input("enter ur groq api key:",type="password")
...
if api_key:
    ...
    if uploaded_files:
        ...
        #split nd create embeddings for documents
